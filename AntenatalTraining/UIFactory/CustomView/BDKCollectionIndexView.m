...
@property (assign, nonatomic) CGFloat backviewAlpha;
...
- (instancetype)initWithFrame:(CGRect)frame indexTitles:(NSArray *)indexTitles {
    ...
    self.titleColor = [UIColor colorWithRed:0 green:120.0 / 255.0 blue:255.0 / 255.0 alpha:1.0];
...
- (UIView *)touchStatusView {
    ...
    _touchStatusView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:_backviewAlpha];
...
- (void)buildIndexLabels {
    ...
    for (NSString *indexTitle in self.indexTitles) {
        ...
        label.textColor = self.titleColor;  //[UIColor colorWithRed:0.415 green:0.451 blue:0.490 alpha:1.0];
...
- (void)setBackgroundVisibility:(BOOL)flag {
    CGFloat alpha = flag ? 0.25 : _backviewAlpha;
